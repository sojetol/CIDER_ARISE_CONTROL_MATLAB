function array = readFromSinglePoint(var,scaling,run,suffix,years,ensemble_number)

suffix_year_1 = str2double(suffix(1:4));
suffix_year_2 = str2double(suffix(8:11));
if strcmp(var,'P-E')
    array = readFromSinglePoint('PRECT',scaling,run,suffix,years,ensemble_number) - readFromSinglePoint('QFLX',scaling/1000,run,suffix,years,ensemble_number);
elseif strcmp(var,'FSNT-FLNT')
    array = readFromSinglePoint('FSNT',scaling,run,suffix,years,ensemble_number) - readFromSinglePoint('FLNT',scaling,run,suffix,years,ensemble_number);
elseif strcmp(var,'SO4')
    array = readFromSinglePoint('TMso4_a1',scaling,run,suffix,years,ensemble_number) +readFromSinglePoint('TMso4_a2',scaling,run,suffix,years,ensemble_number)+readFromSinglePoint('TMso4_a3',scaling,run,suffix,years,ensemble_number);
elseif strcmp(var,'ALL_SULFUR')
    array = readFromSinglePoint('TMSO2',scaling,run,suffix,years,ensemble_number)+readFromSinglePoint('TMso4_a1',scaling,run,suffix,years,ensemble_number)*64.066/96.06*96.06/115 +readFromSinglePoint('TMso4_a2',scaling,run,suffix,years,ensemble_number)*64.066/96.06*96.06/115+readFromSinglePoint('TMso4_a3',scaling,run,suffix,years,ensemble_number)*64.066/96.06*96.06/115;
else
%     if (strcmp(run,'GAUSS-DEFAULT-OFF-2055') || strcmp(run,'GAUSS-DEFAULT-PO-2055')) && ensemble_number>1 && suffix_year_2==2069
    if strcmp(run,'GAUSS-DEFAULT-PO-2055') && ensemble_number>1 && suffix_year_2==2069
        array_1_5 = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.' run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '205501-205912.nc']],var)*scaling;
        try
        array_6_15 = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.' run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '205501-206912.nc']],var)*scaling;
        
        catch
        array_6_15 = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.' run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '205912-206912.nc']],var)*scaling;
        end
    ...
    elseif strcmp(run,'GAUSS-LOWER-1.0') && ensemble_number>1 && suffix_year_2==2069
        ...
        array = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.' run '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix]],var)*scaling;
    elseif (strcmp(run,'GAUSS-DEFAULT-RESTART-2055-1y')||strcmp(run,'GAUSS-DEFAULT-RESTART-2055-2y')) && ensemble_number==1 %&& 0==1
        ...
        array = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.' run '.00' int2str(ensemble_number) '.cam.h0.' var '.' old_suffix]],var)*scaling;
        array2 = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.' run '.00' int2str(ensemble_number) '.redone.cam.h0.' var '.' suffix]],var)*scaling;
        array3 = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.' run '.00' int2str(ensemble_number) '.redone.cam.h0.' var '.' suffix3]],var)*scaling;
    ...
    elseif (strcmp(run,'GAUSS-DEFAULT-RESTART-2055-1y')||strcmp(run,'GAUSS-DEFAULT-RESTART-2055-2y')) && ensemble_number==2
        ...
        array = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.' run '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix]],var)*scaling;
        array3 = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.' run '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix3]],var)*scaling;
        array3_size = size(array3);
        array = array(:,:,13:end);
    ...
    if years(1)<suffix_year_1 || strcmp(run,'GAUSS-DEFAULT-RESTART-2055-1y') || strcmp(run,'GAUSS-DEFAULT-RESTART-2055-2y')
        if strcmp(run,'GAUSS-DEFAULT-OFF-2055') || strcmp(run,'GAUSS-DEFAULT-PO-2055')
            array2 = array;
            size2 = size(array2);
            array = readFromSinglePoint(var,scaling,['GAUSS-DEFAULT'],['203501-206912.nc'],[years(1) 2054],ensemble_number);
            size1 = size(array);
        ...
        elseif (strcmp(run,'GAUSS-DEFAULT-RESTART-2055-1y')&& years(1)<2056) || (strcmp(run,'GAUSS-DEFAULT-RESTART-2055-2y')&&years(1)<2057)
            ...
            array2 = array;
            size2 = size(array2);
            array = readFromSinglePoint(var,scaling,['GAUSS-DEFAULT-OFF-2055'],['205501-206912.nc'],[years(1) 2054+interrupt_size],ensemble_number);
            size1 = size(array);
            array(:,:,(size1(3)+1):(size1(3)+size2(3))) = array2;
