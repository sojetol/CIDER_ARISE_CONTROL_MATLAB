...
if strcmp(run,'GAUSS-UNCOORD')
    model_data = 'b.e21.BWSSP245.f09_g17.release-cesm2.1.5.WACCM-MA-1deg.SSP245-MA-';
else
    model_data = 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.SSP245-MA-';
end
...
%     if (strcmp(run,'GAUSS-DEFAULT-OFF-2055') || strcmp(run,'GAUSS-DEFAULT-PO-2055')) && ensemble_number>1 && suffix_year_2==2069
    if strcmp(run,'GAUSS-DEFAULT-PO-2055') && ensemble_number>1 && suffix_year_2==2069
        array_1_5 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '205501-205912.nc']],var)*scaling;
        try
        array_6_15 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '205501-206912.nc']],var)*scaling;
        
        catch
        array_6_15 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '205912-206912.nc']],var)*scaling;
        end
        array = cat(3,array_1_5,array_6_15(:,:,2:end));
    elseif strcmp(run,'GAUSS-UNCOORD') && suffix_year_2~=2036 && suffix_year_2~=2045 && ensemble_number==1
        uncoord_data_1 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '203501-203612.nc']],var)*scaling;
        uncoord_data_2 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '203512-204512.nc']],var)*scaling;
        uncoord_data_3 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '204412-' suffix(8:11) '12.nc']],var)*scaling;
        array = cat(3,uncoord_data_1(:,:,1:12),uncoord_data_2(:,:,2:end),uncoord_data_3(:,:,14:end));
        % spliced_AOD = [uncoord_data_1.ensemble_monthly_average(1:12);uncoord_data_2.ensemble_monthly_average(2:end);uncoord_data_3.ensemble_monthly_average(14:end)];
    elseif strcmp(run,'GAUSS-UNCOORD') && suffix_year_2~=2041 && ensemble_number==3
        uncoord_data_1 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '203501-204112.nc']],var)*scaling;
        uncoord_data_2 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' '204112-207512.nc']],var)*scaling;
        array = cat(3,uncoord_data_1(:,:,:),uncoord_data_2(:,:,2:end));
     
    elseif strcmp(run,'GAUSS-LOWER-1.0') && ensemble_number>1 && suffix_year_2==2069
        suffix_year_2 = 2070;
        suffix = '203501-207012.nc';
        array = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix]],var)*scaling;
    elseif (strcmp(run,'GAUSS-DEFAULT-RESTART-2055-1y')||strcmp(run,'GAUSS-DEFAULT-RESTART-2055-2y')) && ensemble_number==1 %&& 0==1
        ...
        array = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' old_suffix]],var)*scaling;
        array2 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.redone.cam.h0.' var '.' suffix]],var)*scaling;
        array3 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.redone.cam.h0.' var '.' suffix3]],var)*scaling;
    ...
    elseif (strcmp(run,'GAUSS-DEFAULT-RESTART-2055-1y')||strcmp(run,'GAUSS-DEFAULT-RESTART-2055-2y')) && ensemble_number==2
        ...
        array = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix]],var)*scaling;
        array3 = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix3]],var)*scaling;
        array3_size = size(array3);
        array = array(:,:,13:end);
    ...
    elseif (strcmp(run,'GAUSS-DEFAULT-RESTART-2055-1y')||strcmp(run,'GAUSS-DEFAULT-RESTART-2055-2y')) && ensemble_number==3
        ...
        suffix_year_1 = str2double(suffix(1:4));
        suffix_year_2 = str2double(suffix(8:11));
    elseif strcmp(run,'GAUSS-60N_60S-LOWER-0.5')||strcmp(run,'GAUSS-30N_30S-LOWER-0.5')||strcmp(run,'GAUSS-15N_15S-LOWER-0.5')||strcmp(run,'GAUSS-0N-LOWER-0.5')
        if strcmp(run,'GAUSS-60N_60S-LOWER-0.5')
            array = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.feedback_60N_60S_1.0'  '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix]],var)*scaling;
        elseif strcmp(run,'GAUSS-30N_30S-LOWER-0.5')
            array = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.feedback_30N_30S'  '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix]],var)*scaling;
        elseif strcmp(run,'GAUSS-15N_15S-LOWER-0.5')
            array = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.feedback_15N_15S'  '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix]],var)*scaling;
        else
            array = ncread(['Climate_Data/' run '/' [ 'b.e21.BWSSP245.f09_g17.release-cesm2.1.3.WACCM-MA-1deg.feedback_0N_1.0' '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix]],var)*scaling;
        end
    else
        array = ncread(['Climate_Data/' run '/' [ model_data run '.00' int2str(ensemble_number) '.cam.h0.' var '.' suffix]],var)*scaling;
    end
    ...
    if years(1)<suffix_year_1 || strcmp(run,'GAUSS-DEFAULT-RESTART-2055-1y') || strcmp(run,'GAUSS-DEFAULT-RESTART-2055-2y')
        ...
        elseif (strcmp(run,'GAUSS-DEFAULT-RESTART-2055-1y')&& years(1)<2056) || (strcmp(run,'GAUSS-DEFAULT-RESTART-2055-2y')&&years(1)<2057)
            ...
            size1 = size(array);
            array(:,:,(size1(3)+1):(size1(3)+size2(3))) = array2;
        elseif strcmp(run,'GAUSS-DEFAULT')||strcmp(run,'GAUSS-LOWER-1.0')||strcmp(run,'GAUSS-LOWER-0.5')||strcmp(run,'GAUSS-30N_30S-LOWER-0.5')||strcmp(run,'GAUSS-15N_15S-LOWER-0.5')||strcmp(run,'GAUSS-0N-LOWER-0.5')
            array2 = array;
            size2 = size(array2);
            p = [];
