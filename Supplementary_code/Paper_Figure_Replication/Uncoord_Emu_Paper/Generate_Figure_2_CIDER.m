...
ssp245_P_data_2030 = processRun('PRECT',pdimchange,'SSP245','203501-206912.nc',[2015 2069],[1 2 3]);
P_SSP245_matrix = ssp245_P_data_2030.ensemble_monthly_matrix;
P_SSP245_matrix_base = mean(P_SSP245_matrix(:,:,12*5+1:12*25),3);
P_SSP245_matrix = P_SSP245_matrix(:,:,12*20+1:12*55) - P_SSP245_matrix_base;
pattern_P_base = P_SSP245_matrix_base;
P_base_2030 = globalMean(P_SSP245_matrix_base);
...
feedback_60_T_data = processRun('TREFHT',1,'GAUSS-60N_60S-LOWER-0.5','203501-206912.nc',[2035 2069],[1 2 3]);
...
T_60NS_fdbk = feedback_60_T_data.ensemble_monthly_average - T_base;
...
feedback_60_P_data = processRun('PRECT',1000*24*60*60,'GAUSS-60N_60S-LOWER-0.5','203501-206912.nc',[2035 2069],[1 2 3]);
...
P_60NS_fdbk = feedback_60_P_data.ensemble_monthly_average - P_base;
...
my_tile = nexttile(2);
hold on
plot(ann_time, ssp245_T_data.ensemble_annual_average-PIT,"LineWidth",2,"Color",'k')
plot(ann_time, averageEvery2d(12,1,T_60N+T_SSP245+T_base-PIT),"LineWidth",2,"Color",colors(1,:))
plot(ann_time, averageEvery2d(12,1,T_30N+T_SSP245+T_base-PIT),"LineWidth",2,"Color",colors(2,:))
plot(ann_time, averageEvery2d(12,1,T_15N+T_SSP245+T_base-PIT),"LineWidth",2,"Color",colors(3,:))
plot(ann_time, averageEvery2d(12,1,T_0N+T_SSP245+T_base-PIT),"LineWidth",2,"Color",colors(4,:))
plot(ann_time, averageEvery2d(12,1,T_15S+T_SSP245+T_base-PIT),"LineWidth",2,"Color",colors(5,:))
plot(ann_time, averageEvery2d(12,1,T_30S+T_SSP245+T_base-PIT),"LineWidth",2,"Color",colors(6,:))
plot(ann_time, averageEvery2d(12,1,T_60S+T_SSP245+T_base-PIT),"LineWidth",2,"Color",colors(7,:))
for i = 1:8
    if i == 1
        injection_12_60N = [];
        for j = 1:35
    ...
    plot(ann_time, averageEvery2d(12,1,T_emu+T_base-PIT),"LineWidth",2,"Color",color,"LineStyle","--")
end
hold off
% legend(sp_legend)
...
my_tile = nexttile(3);
hold on
plot(ann_time, ssp245_P_data.ensemble_annual_average-P_base_2030,"LineWidth",2,"Color",'k')
plot(ann_time, averageEvery2d(12,1,P_60N+P_SSP245)+P_base-P_base_2030,"LineWidth",2,"Color",colors(1,:))
plot(ann_time, averageEvery2d(12,1,P_30N+P_SSP245)+P_base-P_base_2030,"LineWidth",2,"Color",colors(2,:))
plot(ann_time, averageEvery2d(12,1,P_15N+P_SSP245)+P_base-P_base_2030,"LineWidth",2,"Color",colors(3,:))
plot(ann_time, averageEvery2d(12,1,P_0N+P_SSP245)+P_base-P_base_2030,"LineWidth",2,"Color",colors(4,:))
plot(ann_time, averageEvery2d(12,1,P_15S+P_SSP245)+P_base-P_base_2030,"LineWidth",2,"Color",colors(5,:))
plot(ann_time, averageEvery2d(12,1,P_30S+P_SSP245)+P_base-P_base_2030,"LineWidth",2,"Color",colors(6,:))
plot(ann_time, averageEvery2d(12,1,P_60S+P_SSP245)+P_base-P_base_2030,"LineWidth",2,"Color",colors(7,:))
for i = 1:8
    if i == 1
        injection_12_60N = [];
        for j = 1:35
    ...
    plot(ann_time, averageEvery2d(12,1,P_emu)+P_base-P_base_2030,"LineWidth",2,"Color",color,"LineStyle","--")
end
hold off
% legend(sp_legend)
ylabel("Precip. change (mm/day)")
my_tile.TitleHorizontalAlignment = 'left';
my_title = "(c)";
box on 
grid on
...
hold on
plot(ann_time, ssp245_T_data.ensemble_annual_average-PIT,"LineWidth",2,"Color",'k')
plot(ann_time, averageEvery2d(12,1,T_EQ_fdbk(1:end)+T_base-PIT),"LineWidth",2,"Color",colors2(1,:))
plot(ann_time, averageEvery2d(12,1,T_15NS_fdbk(1:end)+T_base-PIT),"LineWidth",2,"Color",colors2(2,:))
plot(ann_time, averageEvery2d(12,1,T_30NS_fdbk(1:end)+T_base-PIT),"LineWidth",2,"Color",colors2(3,:))
plot(ann_time, averageEvery2d(12,1,T_60NS_fdbk(1:end)+T_base-PIT),"LineWidth",2,"Color",colors2(4,:))
...
plot(ann_time, averageEvery2d(12,1,T_emu_SSP245+T_base-PIT),"LineWidth",2,"Color",'k',"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,T_emu_fdbk_EQ+T_base-PIT),"LineWidth",2,"Color",colors2(1,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,T_emu_fdbk_15NS+T_base-PIT),"LineWidth",2,"Color",colors2(2,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,T_emu_fdbk_30NS+T_base-PIT),"LineWidth",2,"Color",colors2(3,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,T_emu_fdbk_60NS+T_base-PIT),"LineWidth",2,"Color",colors2(4,:),"LineStyle","--")
...
hold on
plot(ann_time, ssp245_P_data.ensemble_annual_average-P_base_2030,"LineWidth",2,"Color",'k')
plot(ann_time, averageEvery2d(12,1,P_EQ_fdbk(1:end))+P_base-P_base_2030,"LineWidth",2,"Color",colors2(1,:))
plot(ann_time, averageEvery2d(12,1,P_15NS_fdbk(1:end))+P_base-P_base_2030,"LineWidth",2,"Color",colors2(2,:))
plot(ann_time, averageEvery2d(12,1,P_30NS_fdbk(1:end))+P_base-P_base_2030,"LineWidth",2,"Color",colors2(3,:))
plot(ann_time, averageEvery2d(12,1,P_60NS_fdbk(1:end))+P_base-P_base_2030,"LineWidth",2,"Color",colors2(4,:))
...
plot(ann_time, averageEvery2d(12,1,P_emu_SSP245+P_base-P_base_2030),"LineWidth",2,"Color",'k',"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,P_emu_fdbk_EQ+P_base-P_base_2030),"LineWidth",2,"Color",colors2(1,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,P_emu_fdbk_15NS+P_base-P_base_2030),"LineWidth",2,"Color",colors2(2,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,P_emu_fdbk_30NS+P_base-P_base_2030),"LineWidth",2,"Color",colors2(3,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,P_emu_fdbk_60NS+P_base-P_base_2030),"LineWidth",2,"Color",colors2(4,:),"LineStyle","--")
...
hold on
plot(ann_time,ssp245_AOD_data.ensemble_annual_average,"LineWidth",2,"Color",'k')
plot(ann_time, default_AOD_data.ensemble_annual_average,"LineWidth",2,"Color",colors3(1,:))
plot(ann_time, lower_5_AOD_data.ensemble_annual_average,"LineWidth",2,"Color",colors3(2,:))
plot(ann_time, lower_1_AOD_data.ensemble_annual_average,"LineWidth",2,"Color",colors3(3,:))
...
plot(ann_time, averageEvery2d(12,1,AOD_fdbk_lower_5+AOD_base),"LineWidth",2,"Color",colors3(2,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,AOD_fdbk_lower_1+AOD_base),"LineWidth",2,"Color",colors3(3,:),"LineStyle","--")
% legend("SSP2-4.5","Multiobjective for 1.5°C","Multiobjective for 1.0°C","Multiobjective for 0.5°C","Location","se")
hold off
box on 
grid on
ylabel("AOD")
...
title(my_title,"FontSize",20)
set(gca,'FontSize', 20)
legend("SSP2-4.5","Multiobjective for 1.5°C","Multiobjective for 1.0°C","Multiobjective for 0.5°C","Location","se","FontSize",12)
xlim([2035 2070])
...
hold on
plot(ann_time, ssp245_T_data.ensemble_annual_average-PIT,"LineWidth",2,"Color",'k')
plot(ann_time, default_T_data.ensemble_annual_average-PIT,"LineWidth",2,"Color",colors3(1,:))
plot(ann_time, lower_5_T_data.ensemble_annual_average-PIT,"LineWidth",2,"Color",colors3(2,:))
plot(ann_time, lower_1_T_data.ensemble_annual_average-PIT,"LineWidth",2,"Color",colors3(3,:))
plot(ann_time, averageEvery2d(12,1,T_emu_SSP245+T_base-PIT),"LineWidth",2,"Color",'k',"LineStyle","--")
...
plot(ann_time, averageEvery2d(12,1,T_emu_arise+T_base-PIT),"LineWidth",2,"Color",colors3(1,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,T_emu_lower_5+T_base-PIT),"LineWidth",2,"Color",colors3(2,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,T_emu_lower_1+T_base-PIT),"LineWidth",2,"Color",colors3(3,:),"LineStyle","--")
ylabel("Temperature (°C above PI)")
xlim([2035 2070])
...
hold on
plot(ann_time, ssp245_P_data.ensemble_annual_average-P_base_2030,"LineWidth",2,"Color",'k')
plot(ann_time, default_P_data.ensemble_annual_average-P_base_2030,"LineWidth",2,"Color",colors3(1,:))
plot(ann_time, lower_5_P_data.ensemble_annual_average-P_base_2030,"LineWidth",2,"Color",colors3(2,:))
plot(ann_time, lower_1_P_data.ensemble_annual_average-P_base_2030,"LineWidth",2,"Color",colors3(3,:))
plot(ann_time, averageEvery2d(12,1,P_emu_SSP245+P_base-P_base_2030),"LineWidth",2,"Color",'k',"LineStyle","--")
P_emu_arise = globalMean(CIDER_pattern_from_all_injections_and_CO2([injection_default_monthly CO2_forcing_SSP245_month], param_AOD_all,param_P_all,pattern_P_all));
P_emu_lower_5 = globalMean(CIDER_pattern_from_all_injections_and_CO2([injection_lower_5_monthly CO2_forcing_SSP245_month], param_AOD_all,param_P_all,pattern_P_all));
P_emu_lower_1 = globalMean(CIDER_pattern_from_all_injections_and_CO2([injection_lower_1_monthly CO2_forcing_SSP245_month], param_AOD_all,param_P_all,pattern_P_all));
plot(ann_time, averageEvery2d(12,1,P_emu_arise+P_base-P_base_2030),"LineWidth",2,"Color",colors3(1,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,P_emu_lower_5+P_base-P_base_2030),"LineWidth",2,"Color",colors3(2,:),"LineStyle","--")
plot(ann_time, averageEvery2d(12,1,P_emu_lower_1+P_base-P_base_2030),"LineWidth",2,"Color",colors3(3,:),"LineStyle","--")
ylabel("Precip. Change (mm/day)")
xlim([2035 2070])
...
print(gcf,'-dpng',["Uncoord_Emu_Paper/Uncoord_Plots/Figure_1_" + getNow() + ".png"],'-r300')

%% Get Data
T_emu_ssp_ann = averageEvery2d(12,1,T_emu_SSP245+T_base);
T_emu_arise_ann = averageEvery2d(12,1,T_emu_arise+T_base);

simulation_cooling_arise =   default_T_data.ensemble_annual_average-ssp245_T_data.ensemble_annual_average;
emulation_cooling_arise = T_emu_arise_ann-T_emu_ssp_ann;
T_emu_1_ann = averageEvery2d(12,1,T_emu_lower_1+T_base);
simulation_cooling_arise =   default_T_data.ensemble_annual_average-ssp245_T_data.ensemble_annual_average;
simulation_cooling_1 =   lower_1_T_data.ensemble_annual_average-ssp245_T_data.ensemble_annual_average;
emulation_cooling_1 = T_emu_1_ann-T_emu_ssp_ann;
1-mean(emulation_cooling_arise(16:end)./simulation_cooling_arise(16:end));
1-mean(emulation_cooling_1(16:end)./simulation_cooling_1(16:end));

sqrt(mean((lower_5_T_data.ensemble_annual_average(16:end)-averageEvery2d(12,1,T_emu_lower_5(181:end)+T_base)).^2))
sqrt(mean((lower_5_P_data.ensemble_annual_average(16:end)-averageEvery2d(12,1,P_emu_lower_5(181:end)+P_base)).^2))
std(reshape(lower_5_T_data.individual_annual_average(16:end,:),60,1))
std(reshape(lower_5_P_data.individual_annual_average(16:end,:),60,1))
AOD_lower = averageEvery2d(12,1,AOD_fdbk_lower_5);
mean(AOD_lower(16:end)./(lower_5_AOD_data.ensemble_annual_average(16:end)-AOD_base))
